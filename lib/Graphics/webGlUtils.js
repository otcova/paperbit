...
exports.GLTexture = exports.GLBuffer = exports.GLProgram = exports.GLVao = void 0;
const NUMBER_SIZE = 4;
function error(msg) {
    throw Error(msg);
}
...
class GLProgram {
    ...
    setVecAttrib(name, vecDimensions, stride = null, offset = 0, type = "f") {
        ...
        if (type == "f") {
            this.gl.vertexAttribPointer(locationIndex, vecDimensions, type === "f" ? this.gl.FLOAT : this.gl.INT, false, stride * NUMBER_SIZE, offset * NUMBER_SIZE);
        }
        else {
            this.gl.vertexAttribIPointer(locationIndex, vecDimensions, this.gl.INT, stride * NUMBER_SIZE, offset * NUMBER_SIZE);
        }
...
class GLTexture extends GLTextureConfig {
