...
class GraphicsStateStack {
    ...
    set texture(id) { this.current.textureID = typeof id === "number" ? id : id.slot; }
...
class GraphicsFunctions {
    ...
    ellipse(x, y, width, height) {
        ...
        this.buffer.push([
            b[0], b[1], b[2], -height, height, ...this.state.color, 1,
            d[0], d[1], d[2], -height, -height, ...this.state.color, 1,
            c[0], c[1], c[2], height, -height, ...this.state.color, 1,
            c[0], c[1], c[2], height, -height, ...this.state.color, 1,
            a[0], a[1], a[2], height, height, ...this.state.color, 1,
            b[0], b[1], b[2], -height, height, ...this.state.color, 1,
        ]);
    }
    rect(x, y, width, height) {
        ...
        const textureID = this.state.texture;
        this.buffer.push([
            vb[0], vb[1], vb[2], uv[6], uv[7], r, g, b, a, textureID,
            vd[0], vd[1], vd[2], uv[2], uv[3], r, g, b, a, textureID,
            vc[0], vc[1], vc[2], uv[0], uv[1], r, g, b, a, textureID,
            vc[0], vc[1], vc[2], uv[0], uv[1], r, g, b, a, textureID,
            va[0], va[1], va[2], uv[4], uv[5], r, g, b, a, textureID,
            vb[0], vb[1], vb[2], uv[6], uv[7], r, g, b, a, textureID,
        ]);
    }
