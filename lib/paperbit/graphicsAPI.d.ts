...
declare type ColorParam = number[] | number;
declare class GraphicsStateStack {
    private stateStack;
    set color(c: ColorParam);
    get color(): [number, number, number, number];
    set stroke(enable: boolean);
    get stroke(): boolean;
    set lineColor(c: ColorParam);
    get lineColor(): ColorParam;
    ...
    set texture(id: number | {
        slot: number;
    });
    get texture(): number;
    set quadUV(uv: Tuple<number, 8>);
    get quadUV(): Tuple<number, 8>;
